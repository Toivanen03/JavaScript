...
const numerot = {1: yksi = '<img src="Kuvat/Numerot/1.png" alt="yksi">',            //Lista sisältää saldonäytön numerokuvien polut
    2: '<img src="Kuvat/Numerot/2.png" alt="kaksi">',
    3: '<img src="Kuvat/Numerot/3.png" alt="kolme">',
    4: '<img src="Kuvat/Numerot/4.png" alt="neljä">',
    5: '<img src="Kuvat/Numerot/5.png" alt="viisi">',
    6: '<img src="Kuvat/Numerot/6.png" alt="kuusi">',
    7: '<img src="Kuvat/Numerot/7.png" alt="seitsemän">',
    8: '<img src="Kuvat/Numerot/8.png" alt="kahdeksan">',
    9: '<img src="Kuvat/Numerot/9.png" alt="yhdeksän">',
    0: '<img src="Kuvat/Numerot/0.png" alt="nolla">',
};
...
const rivit = {"luumu": ["Kuvat/Kelat/paarynaLUUMUappelsiini.png", "Kuvat/Kelat/paarynaLUUMUtahti.png", "Kuvat/Kelat/paarynaLUUMUrypale.png"],
    "appelsiini": ["Kuvat/Kelat/luumuAPPELSIINIpaaryna.png", "Kuvat/Kelat/meloniAPPELSIINItahti.png", "Kuvat/Kelat/paarynaAPPELSIINIrypale.png"],
    "rypale": ["Kuvat/Kelat/luumuRYPALEappelsiini.png", "Kuvat/Kelat/luumuRYPALEpaaryna.png", "Kuvat/Kelat/luumuRYPALEmeloni.png"],
    "paaryna": ["Kuvat/Kelat/meloniPAARYNArypale.png", "Kuvat/Kelat/rypalePAARYNAappelsiini.png", "Kuvat/Kelat/rypalePAARYNAluumu.png"],
    "tahti": ["Kuvat/Kelat/meloniTAHTIappelsiini.png", "Kuvat/Kelat/meloniTAHTIrypale.png", "Kuvat/Kelat/rypaleTAHTIluumu.png"],
    "kolmeTahtea": ["Kuvat/Kelat/meloniTAHTIappelsiini.png", "Kuvat/Kelat/meloniTAHTIrypale.png", "Kuvat/Kelat/rypaleTAHTIluumu.png"],
    "meloni": ["Kuvat/Kelat/paarynaMELONItahti.png", "Kuvat/Kelat/rypaleMELONIluumu.png", "Kuvat/Kelat/tahtiMELONIrypale.png"]
}
...
window.onload = function() {                //Sivua avatessa päivitetään näytölle aloitussaldot sekä oletuskuvat
    if (pelinAlku) {
        ...
        document.getElementById("lukko1").innerHTML = '<img src="Kuvat/lukitsematta.png" alt="Lukitus kela 1">';
        document.getElementById("lukko2").innerHTML = '<img src="Kuvat/lukitsematta.png" alt="Lukitus kela 2">';
        document.getElementById("lukko3").innerHTML = '<img src="Kuvat/lukitsematta.png" alt="Lukitus kela 3">';
        document.getElementById("lukko4").innerHTML = '<img src="Kuvat/lukitsematta.png" alt="Lukitus kela 4">';
    }
}
...
function naytaKelaPainikkeet() {                //Kelapainikkeet vilkkuvat kuten oikeassa pelikoneessa silloin, kun lukitus on
    ...
    if (lukitusMahdollinen) {
        vilkku = setInterval(function () {
            if (!vilkku1) {
                lukko1.innerHTML = '<img src="Kuvat/lukitsematta.png" alt="Lukitus kela 1">';
            }
            if (!vilkku2) {
                lukko2.innerHTML = '<img src="Kuvat/lukitsematta.png" alt="Lukitus kela 2">';
            }
            if (!vilkku3) {
                lukko3.innerHTML = '<img src="Kuvat/lukitsematta.png" alt="Lukitus kela 3">';
            }
            if (!vilkku4) {
                lukko4.innerHTML = '<img src="Kuvat/lukitsematta.png" alt="Lukitus kela 4">';
            }
            setTimeout(function () {
                if (lukitusMahdollinen) {
                    lukko1.innerHTML = '<img src="Kuvat/lukittu.png" alt="Lukitus kela 1">';
                }
                if (lukitusMahdollinen) {
                    lukko2.innerHTML = '<img src="Kuvat/lukittu.png" alt="Lukitus kela 2">';
                }
                if (lukitusMahdollinen) {
                    lukko3.innerHTML = '<img src="Kuvat/lukittu.png" alt="Lukitus kela 3">';
                }
                if (lukitusMahdollinen) {
                    lukko4.innerHTML = '<img src="Kuvat/lukittu.png" alt="Lukitus kela 4">';
                }
            }, 450);
        }, 900);
    } else {
