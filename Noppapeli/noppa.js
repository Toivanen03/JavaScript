...
let kuvat = ["Kuvat/Nopat/1.png", "Kuvat/Nopat/2.png", "Kuvat/Nopat/3.png", "Kuvat/Nopat/4.png", "Kuvat/Nopat/5.png", "Kuvat/Nopat/6.png"];
let index = 0;
let tuplat;
let tuplatHeitetty;
        ...
        let ajastus = setInterval(function () {
            ...
            if (index === kuvat.length * 3) {
                ...
                setTimeout(function () {
                    ...
                    heittoVuoronPisteet = parseInt(noppaKuva1[12]);          //Polusta otetaan kuvatiedoston nimi indeksillä ja tallennetaan lukuna muuttujaan
                    document.getElementById("noppaYksi").innerHTML = '<img src="' + kuvat[satunnainen] + '" alt="Noppa" width="150px">';
                    pistelaskuri();
                }, 800);
            }
        ...
        let ajastus = setInterval(function () {
            ...
            if (index === kuvat.length * 3) {
                ...
                setTimeout(function () {
                    ...
                    heittoVuoronPisteet = parseInt(noppaKuva1[12]);          //Polusta otetaan kuvatiedoston nimi indeksillä ja tallennetaan lukuna muuttujaan
                    heittoVuoronPisteet2 = parseInt(noppaKuva2[12]);
                    document.getElementById("noppaYksiKauttaKaksi").innerHTML = '<img src="' + kuvat[satunnainen1] + '" alt="Noppa" width="150px">';
                    document.getElementById("noppaKaksiKauttaKaksi").innerHTML = '<img src="' + kuvat[satunnainen2] + '" alt="Noppa" width="150px">';
                    pistelaskuri();
                }, 800);
